...
export const translations = {
  en: {
    ...
    blog: {
      ...
      indexIntro:
        "Practical notes on building for the web and working with Claude Code — from the person behind ClockedCode and UsageCut.",
      backToSite: "Neo Zino",
      readArticle: "Read",
      minRead: "min read",
      onThisPage: "On this page",
      backToBlog: "All notes",
      empty: "No notes published yet. Check back soon.",
      promoTitle: "Built by Neo Zino",
      promoPitch: "I build tools for Claude Code and ship websites for a living.",
      promoCta: "See what I make",
      ctaTitle: "Need this built for you?",
      ctaPitch: "I design and ship fast, custom websites end to end.",
  ...
  he: {
    ...
    services: {
      ...
      left: {
        ...
        titleA: "דפי נחיתה",
        titleB: "ואתרי תדמית",
        whoAnswer: "לעסקים קטנים ואנשי מקצוע.",
        description:
      ...
      right: {
        ...
        whoAnswer: "לעסקים שרוצים לצמוח דיגיטלית.",
        description:
    ...
    blog: {
      navLabel: "בלוג",
      indexTitle: "רשומות מהשטח",
      indexIntro:
        "רשימות פרקטיות על בנייה לרשת ועבודה עם Claude Code — מהאדם שמאחורי ClockedCode ו-UsageCut.",
      backToSite: "Neo Zino",
      readArticle: "קריאה",
      minRead: "דק׳ קריאה",
      onThisPage: "בעמוד הזה",
      backToBlog: "לכל הרשומות",
      empty: "עדיין אין רשומות. בקרו שוב בקרוב.",
      promoTitle: "נבנה על ידי Neo Zino",
      promoPitch: "אני בונה כלים ל-Claude Code ומקים אתרים למחייה.",
      promoCta: "מה אני בונה",
      ctaTitle: "צריך שיבנו לך את זה?",
      ctaPitch: "אני מעצב ומקים אתרים מהירים ומותאמים אישית מקצה לקצה.",
      ctaButton: "התחלת פרויקט",
    },
  },
} as const;
